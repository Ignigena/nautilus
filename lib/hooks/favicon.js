...
module.exports = function faviconHook(app) {
  var faviconPath = path.resolve(__dirname, '../resources/favicon.ico');
  var staticPath = require('../util/getStaticPath')(app);
  var appFavicon = path.resolve(staticPath, 'favicon.ico');
