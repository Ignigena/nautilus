  ...
  _.each(app.api.model, function(settings, model) {
    ...
    app.route(`/${model}/:id?`)
      ...
      .post((req, res) => {
        // Create
        // --
        if (app.api.controller[model].create) {
      ...
      .put((req, res) => {
        ...
        if (app.api.controller[model].update) {
      ...
      .delete((req, res, next) => {
        // Delete
        // --
        if (app.api.controller[model].delete) {
